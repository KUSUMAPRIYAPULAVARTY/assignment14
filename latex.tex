...
\begin{align}
  \mathbbf{T}(\vec{A})=\vec{B}\vec{A} \in \vec{W}\label{6}\\
  \implies \mathbbf{T}_1(\vec{B}\vec{A})=\vec{A} \in \vec{V}\label{7}
\end{align}
...
Let us define $\mathbbf{T}_1$ that satisfies \eqref{7} as 
\begin{align}
    [\mathbbf{T}_1(\vec{C})]_{m \times n}=\vec{B}^{-1}_{m \times p}\vec{C}_{p\times n} \text{ where }\vec{C} \in \vec{W}\\
    \eqref{7} \implies \vec{B}^{-1}(\vec{B}\vec{A}) =\vec{A}\\\implies \vec{B}^{-1}\vec{B}=\vec{I}_{m \times m}\label{3}\\
    \eqref{6} \implies  \vec{B}(\vec{B}^{-1}\vec{C})=\vec{C}\\
